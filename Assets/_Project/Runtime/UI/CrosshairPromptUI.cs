...
public class CrosshairPromptUI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        AnimateTo(mousePosition, targetCenter, targetSize, hovering, target.IsTyping, active);
    }
    ...
    private void AnimateTo(Vector2 mousePosition, Vector2 targetCenter, Vector2 targetSize, bool hovering, bool typing, bool active)
    {
        ...
        UpdateSatellites(mousePosition, targetCenter, targetSize, hovering, active);
    ...
    private void UpdateSatellites(Vector2 mousePosition, Vector2 targetCenter, Vector2 targetSize, bool hovering, bool active)
    {
        ...
        float orbitRadians = cornerOrbitRotation * Mathf.Deg2Rad;
        ...
        for (int i = 0; i < satellites.Count; i++)
        {
            ...
            else
            {
                ...
                corner.Root.localRotation = Quaternion.Euler(0f, 0f, cornerOrbitRotation);
