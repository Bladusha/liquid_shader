...
public class WorkzoneSelectionController : MonoBehaviour
{
    ...
    private bool TrySelectObject(Transform target)
    {
        ...
        if (target == currentSelectedObject)
        {
            ...
            {
                crosshairUI.ShowPrompt("Press E to interact");
                crosshairUI.SetCrosshairState(true, false);
                UpdateCrosshairTarget(target, "Press E to interact", false);
            }
    ...
    private void TryInteractWithObject()
    {
        ...
        IInteractable interactable = currentSelectedObject.GetComponent<IInteractable>();
        ...
        else
        {
            ...
            MonoBehaviour behaviour = currentSelectedObject.GetComponent<MonoBehaviour>();
